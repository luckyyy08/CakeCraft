...
<body>
  <?php include"header.php";?>
   ...
   <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 700px;">
        ...
        <h1 class="display-4 text-uppercase">Engagment Cake's</h1>
    </div>
...
<div class="col-md-4 cake-item" data-price="1899" data-type="eggless" data-flavor="vanilla">
  <div class="cake-card">
    <img src="img/ecake1.jpeg" class="img-fluid" alt='The "Yes" Rose Gold Cake'>
...
<div class="col-md-4 cake-item" data-price="2100" data-type="eggless" data-flavor="chocolate">
  <div class="cake-card">
    <img src="img/ecake2.jpeg" class="img-fluid" alt="Marbled Romance">
    <div class="p-3 text-center">
...
<div class="col-md-4 cake-item" data-price="2499" data-type="egg" data-flavor="fruit">
  <div class="cake-card">
    <img src="img/ecake3.jpeg" class="img-fluid" alt="Hand-Painted Floral Blush">
    <div class="p-3 text-center">
...
<div class="col-md-4 cake-item" data-price="1999" data-type="eggless" data-flavor="strawberry">
  <div class="cake-card">
    <img src="img/ecake4.jpeg" class="img-fluid" alt="Champagne & Strawberries">
    <div class="p-3 text-center">
...
<div class="col-md-4 cake-item" data-price="2800" data-type="eggless" data-flavor="red-velvet">
  <div class="cake-card">
    <img src="img/ecake5.jpeg" class="img-fluid" alt="Gilded Heart Tier">
    <div class="p-3 text-center">
...
<div class="col-md-4 cake-item" data-price="2250" data-type="egg" data-flavor="chocolate">
  <div class="cake-card">
    <img src="img/ecake6.jpeg" class="img-fluid" alt="Modern Geometric Love">
    <div class="p-3 text-center">
...
<div class="col-md-4 cake-item" data-price="2600" data-type="eggless" data-flavor="vanilla">
  <div class="cake-card">
    <img src="img/ecake7.jpeg" class="img-fluid" alt="Pearl & Lace Delicacy">
    <div class="p-3 text-center">
